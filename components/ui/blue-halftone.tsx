...
// Dark theme: a subtle, deep green-tinted halftone that sits on the
// #1A1A1A surface without competing with the green accent. Light theme: the
// shader is disabled (clean off-white surface) for readability.
const UNIFORMS_BY_VARIANT: Record<Variant, Uniforms> = {
  dark: {
    colors: [
      [0.102, 0.102, 0.102],
      [0.121, 0.149, 0.125],
...
export function ShaderBackground({
  ...
  useEffect(() => {
    ...
    if (!canvas) return
    const UNIFORMS = UNIFORMS_BY_VARIANT[variant]
